...
func (o *allJobsLoaderOptions) Run(ctx context.Context) error {
	...
	for i := range jobs {
		...
		go func() {
			...
			jobLoader := o.newAllJobsLoaderOptions(job)
...
func (o *allJobsLoaderOptions) newAllJobsLoaderOptions(job jobrunaggregatorapi.JobRow) *jobLoaderOptions {
...
func (o *jobLoaderOptions) newJobRunLoaderOptions(jobRunID string, readyToUpload chan struct{}) *jobRunLoaderOptions {
